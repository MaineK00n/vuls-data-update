...
type Software struct {
	...
	CampaignsUsing []string                           `json:"campaigns_using,omitempty"` // Campaign IDs ("C*") (reverse of campaign uses software)
}
...
func Compare(x, y Software) int {
	return cmp.Or(
		...
		slices.Compare(x.CampaignsUsing, y.CampaignsUsing),
	)
}
