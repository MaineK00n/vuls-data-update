...
func TestCompare(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				x: packageTypes.Package{Type: packageTypes.PackageType("future-package")},
				y: packageTypes.Package{Type: packageTypes.PackageType("future-package"), Binary: &binaryTypes.Package{Name: "name"}},
			},
			want: -1,
		},
		// TODO: Add test cases.
