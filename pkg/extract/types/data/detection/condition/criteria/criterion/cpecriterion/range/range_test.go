...
func TestRange_Accept(t *testing.T) {
	tests := []struct {
		...
		{name: "gt exclusive lower, above", r: cpecRangeTypes.Range{Type: cpecRangeTypes.RangeTypeSEMVER, GreaterThan: "1.0.0"}, v: "1.0.1", want: true},
		{name: "le inclusive upper, equal", r: cpecRangeTypes.Range{Type: cpecRangeTypes.RangeTypeSEMVER, LessEqual: "2.0.0"}, v: "2.0.0", want: true},
		{name: "le inclusive upper, above", r: cpecRangeTypes.Range{Type: cpecRangeTypes.RangeTypeSEMVER, LessEqual: "2.0.0"}, v: "2.0.1", want: false},
		{name: "lt exclusive upper, equal rejected", r: cpecRangeTypes.Range{Type: cpecRangeTypes.RangeTypeSEMVER, LessThan: "2.0.0"}, v: "2.0.0", want: false},
		{name: "lt exclusive upper, below", r: cpecRangeTypes.Range{Type: cpecRangeTypes.RangeTypeSEMVER, LessThan: "2.0.0"}, v: "1.9.9", want: true},
		{name: "ge+lt window, in", r: cpecRangeTypes.Range{Type: cpecRangeTypes.RangeTypeSEMVER, GreaterEqual: "1.0.0", LessThan: "2.0.0"}, v: "1.5.0", want: true},
		{name: "ge+lt window, below", r: cpecRangeTypes.Range{Type: cpecRangeTypes.RangeTypeSEMVER, GreaterEqual: "1.0.0", LessThan: "2.0.0"}, v: "0.9.0", want: false},
		{name: "ge+lt window, at upper bound", r: cpecRangeTypes.Range{Type: cpecRangeTypes.RangeTypeSEMVER, GreaterEqual: "1.0.0", LessThan: "2.0.0"}, v: "2.0.0", want: false},
		{name: "unparseable v yields false, no error", r: cpecRangeTypes.Range{Type: cpecRangeTypes.RangeTypeSEMVER, LessThan: "2.0.0"}, v: "not-a-semver", want: false},
		{name: "Version (loose) accepts 4-segment", r: cpecRangeTypes.Range{Type: cpecRangeTypes.RangeTypeVersion, LessThan: "9.16.20.0"}, v: "9.16.19.0", want: true},
