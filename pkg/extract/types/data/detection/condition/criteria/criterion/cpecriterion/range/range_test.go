...
func TestRangeType_Compare(t *testing.T) {
	tests := []struct {
		...
		{name: "fortinet: v1 < v2", t: ccRangeTypes.RangeTypeFortinet, v1: "7.0.0", v2: "7.0.1", want: -1},
		...
		{name: "fortinet: bare train below its calendar build (25.2 < 25.2.a)", t: ccRangeTypes.RangeTypeFortinet, v1: "25.2", v2: "25.2.a", want: -1},
		{name: "fortinet: calendar above its bare train (25.2.a > 25.2)", t: ccRangeTypes.RangeTypeFortinet, v1: "25.2.a", v2: "25.2", want: 1},
		{name: "fortinet: calendar below next train (25.2.a < 25.3)", t: ccRangeTypes.RangeTypeFortinet, v1: "25.2.a", v2: "25.3", want: -1},
		{name: "fortinet: calendar above prev train (25.2.a > 25.1)", t: ccRangeTypes.RangeTypeFortinet, v1: "25.2.a", v2: "25.1", want: 1},
		{name: "fortinet: sequential letters (25.2.a < 25.2.b)", t: ccRangeTypes.RangeTypeFortinet, v1: "25.2.a", v2: "25.2.b", want: -1},
		{name: "fortinet: letter patch after letter (25.1.a < 25.1.a.2)", t: ccRangeTypes.RangeTypeFortinet, v1: "25.1.a", v2: "25.1.a.2", want: -1},
		{name: "fortinet: numeric letter-patch ordering (25.1.a.2 < 25.1.a.10)", t: ccRangeTypes.RangeTypeFortinet, v1: "25.1.a.2", v2: "25.1.a.10", want: -1},
		{name: "fortinet: nested calendar above bare train (25.1.a.2 > 25.1)", t: ccRangeTypes.RangeTypeFortinet, v1: "25.1.a.2", v2: "25.1", want: 1},
		{name: "fortinet: pure-numeric trailing zero stays equal (7.2.0 == 7.2)", t: ccRangeTypes.RangeTypeFortinet, v1: "7.2.0", v2: "7.2", want: 0},
