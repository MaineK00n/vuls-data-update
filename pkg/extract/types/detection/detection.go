...
const (
	EcosystemTypeAlma        = "alma:%s"
	EcosystemTypeAlpine      = "alpine:%s"
	EcosystemTypeAmazon      = "amazon:%s"
	EcosystemTypeArch        = "arch"
	EcosystemTypeDebian      = "debian:%s"
	EcosystemTypeEPEL        = "epel:%s"
	EcosystemTypeFedora      = "fedora:%s"
	EcosystemTypeFreeBSD     = "freebsd"
	EcosystemTypeGentoo      = "gentoo"
	EcosystemTypeNetBSD      = "netbsd"
	EcosystemTypeOracle      = "oracle:%s"
	EcosystemTypeRedHat      = "redhat:%s"
	EcosystemTypeRocky       = "rocky:%s"
	EcosystemTypeOpenSUSE    = "opensuse:%s"
	EcosystemTypeSUSEServer  = "sles:%s"
	EcosystemTypeSUSEDesktop = "sled:%s"
	EcosystemTypeUbuntu      = "ubuntu:%s"
	EcosystemTypeWindows     = "windows:%s"
