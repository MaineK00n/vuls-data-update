...
func Fetch(opts ...Option) error {
	...
	resp, err := utilhttp.NewClient(utilhttp.WithClientRetryMax(options.retry), utilhttp.WithClientHTTPClient(options.httpClient), utilhttp.WithClientCheckRetry(checkRetry)).Get(options.baseURL)
	if err != nil {
