...
const dataURL = "https://osv-vulnerabilities.storage.googleapis.com/RubyGems/all.zip"
...
func Fetch(opts ...Option) error {
	...
	for _, zf := range r.File {
		...
		if !ok {
			return errors.Wrapf(err, "unexpected ID format. expected: %q, actual: %q", "(GHSA|MAL)-.+", a.ID)
		}
