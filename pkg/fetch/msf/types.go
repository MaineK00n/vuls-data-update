...
type module struct {
	...
	Rport              any            `json:"rport,omitempty"` // int or string or null
	...
	Notes              map[string]any `json:"notes,omitempty"`         // map[string]string or map[string][]string
	SessionTypes       any            `json:"session_types,omitempty"` // []string or false
	NeedsCleanup       any            `json:"needs_cleanup,omitempty"` // false, true, null
}
