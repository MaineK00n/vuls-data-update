...
type Updateinfo struct {
	...
	Pushcount   string `xml:"pushcount" json:"pushcount,omitempty"`
...
// as a 64-bit integer, but some repositories quote it as a string, so accept
// both a YAML integer and a quoted integer string.
