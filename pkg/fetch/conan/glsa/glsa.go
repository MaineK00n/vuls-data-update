...
const defaultRepoURL = "https://gitlab.com/gitlab-org/advisories-community/-/archive/main/advisories-community-main.tar.gz?path=conan"
...
func Fetch(opts ...Option) error {
	...
	for {
		...
		name, ok := strings.CutPrefix(adv.PackageSlug, "conan/")
		if !ok {
			return errors.Errorf("unexpected package_slug format. expected: %q, actual: %q", "conan/<package name>", adv.PackageSlug)
		}
