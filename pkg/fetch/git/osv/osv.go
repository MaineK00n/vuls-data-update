...
const dataURL = "https://osv-vulnerabilities.storage.googleapis.com/GIT/all.zip"
...
func Fetch(opts ...Option) error {
	...
	for _, zf := range r.File {
		...
		p, err := utilfilepath.Join(options.dir, fmt.Sprintf("%d", t.Year()), fmt.Sprintf("%d", t.Month()), fmt.Sprintf("%s.json", a.ID))
		if err != nil {
