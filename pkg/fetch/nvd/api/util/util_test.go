	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				startIndex:       0,
				resultsPerPage:   1,
				lastModStartDate: new(time.Date(2024, time.April, 15, 0, 0, 0, 0, time.UTC)),
			},
			wantErr: true,
		},
		{
			...
			args: args{
				...
				startIndex:     0,
				resultsPerPage: 1,
				lastModEndDate: new(time.Date(2024, time.April, 15, 0, 0, 0, 0, time.UTC)),
			},
			wantErr: true,
		},
		{
			...
			args: args{
				...
				resultsPerPage:   1,
				lastModStartDate: new(time.Date(2024, time.April, 15, 0, 0, 0, 0, time.UTC)),
				lastModEndDate:   new(time.Date(2024, time.April, 15, 1, 0, 0, 0, time.UTC)),
			},
		...
		},
		{
			...
			args: args{
				...
				startIndex:       0,
				resultsPerPage:   1,
				lastModStartDate: new(time.Date(2023, time.December, 16, 23, 59, 59, 999999999, time.UTC)),
				lastModEndDate:   new(time.Date(2024, time.April, 15, 0, 0, 0, 0, time.UTC)),
			},
			wantErr: true,
		},
		{
			...
			args: args{
				...
				startIndex:       0,
				resultsPerPage:   1,
				lastModStartDate: new(time.Date(2024, time.April, 15, 1, 0, 0, 0, time.UTC)),
				lastModEndDate:   new(time.Date(2024, time.April, 15, 0, 0, 0, 0, time.UTC)),
			},
			wantErr: true,
		},
