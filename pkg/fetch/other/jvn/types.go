...
type Advisory struct {
	...
	DateFirstPublished *time.Time `xml:"VulinfoData>DateFirstPublished" json:"date_first_published,omitempty"`
	DateLastUpdated    *time.Time `xml:"VulinfoData>DateLastUpdated" json:"date_last_updated,omitempty"`
	DatePublic         *time.Time `xml:"VulinfoData>DatePublic" json:"date_public,omitempty"`
}
