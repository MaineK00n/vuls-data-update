...
const defaultRepoURL = "https://gitlab.com/gitlab-org/advisories-community/-/archive/main/advisories-community-main.tar.gz?path=go"
...
func Fetch(opts ...Option) error {
	...
	for {
		...
		name, ok := strings.CutPrefix(adv.PackageSlug, "go/")
		if !ok {
			return errors.Errorf("unexpected package_slug format. expected: %q, actual: %q", "go/<package name>", adv.PackageSlug)
		}
