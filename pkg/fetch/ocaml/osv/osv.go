...
const dataURL = "https://osv-vulnerabilities.storage.googleapis.com/opam/all.zip"
...
func Fetch(opts ...Option) error {
	...
	for _, zf := range r.File {
		...
		if err != nil {
			return errors.Wrapf(err, "unexpected ID format. expected: %q, actual: %q", "OSEC-yyyy-\\d+", a.ID)
		}
