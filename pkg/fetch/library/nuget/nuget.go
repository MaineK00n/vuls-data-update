...
import (
	...
	"github.com/MaineK00n/vuls-data-update/pkg/fetch/library/nuget/ghsa"
	"github.com/MaineK00n/vuls-data-update/pkg/fetch/library/nuget/glsa"
	"github.com/MaineK00n/vuls-data-update/pkg/fetch/library/nuget/osv"
...
func Fetch(opts ...Option) error {
	options := &options{
		dir:   filepath.Join(util.SourceDir(), "nuget"),
		retry: 3,
	}
