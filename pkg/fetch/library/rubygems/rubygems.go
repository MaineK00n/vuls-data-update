...
import (
	...
	"github.com/MaineK00n/vuls-data-update/pkg/fetch/library/rubygems/db"
	"github.com/MaineK00n/vuls-data-update/pkg/fetch/library/rubygems/ghsa"
	"github.com/MaineK00n/vuls-data-update/pkg/fetch/library/rubygems/glsa"
	"github.com/MaineK00n/vuls-data-update/pkg/fetch/library/rubygems/osv"
...
func Fetch(opts ...Option) error {
	options := &options{
		dir:   filepath.Join(util.SourceDir(), "rubygems"),
		retry: 3,
	}
