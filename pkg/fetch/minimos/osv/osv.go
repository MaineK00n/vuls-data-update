...
const dataURL = "https://osv-vulnerabilities.storage.googleapis.com/MinimOS/all.zip"
...
func Fetch(opts ...Option) error {
	...
	for _, zf := range r.File {
		...
		p, err := utilfilepath.Join(options.dir, t.Format("2006"), t.Format("01"), fmt.Sprintf("%s.json", a.ID))
		if err != nil {
