...
const dataURL = "https://osv-vulnerabilities.storage.googleapis.com/npm/all.zip"
...
func Fetch(opts ...Option) error {
	...
	for _, zf := range r.File {
		...
		if !ok {
			return errors.Wrapf(err, "unexpected ID format. expected: %q, actual: %q", "(GHSA|MAL|GSD)-.+", a.ID)
		}
