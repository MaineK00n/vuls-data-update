...
func NewCmdFetch() *cobra.Command {
	...
	cmd.AddCommand(
		...
		newCmdFetchMitre(),
		newCmdFetchMSF(),
		newCmdFetchNVDAPI(), newCmdFetchNVDFeedCVE(), newCmdFetchNVDFeedCPEDictionary(),
	)
...
func newCmdFetchAlmaErrata() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			if err := almaErrata.Fetch(almaErrata.WithDir(filepath.Join(options.dir, "alma", "errata"))); err != nil {
...
func newCmdFetchAlmaOSV() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			// if err := almaOSV.Fetch(almaOSV.WithDir(filepath.Join(options.dir, "alma", "osv"))); err != nil {
			// 	return errors.Wrap(err, "failed to fetch almalinux")
			// }
			return nil
		},
...
func newCmdFetchAlpineSecDB() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			if err := alpineSecDB.Fetch(alpineSecDB.WithDir(filepath.Join(options.dir, "alpine", "secdb"))); err != nil {
...
func newCmdFetchAlpineOSV() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			// if err := alpineOSV.Fetch(alpineOSV.WithDir(filepath.Join(options.dir, "alpine", "osv"))); err != nil {
			// 	return errors.Wrap(err, "failed to fetch alpine linux")
			// }
			return nil
		},
...
func newCmdFetchDebianOSV() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			// if err := debianOSV.Fetch(debianOSV.WithDir(filepath.Join(options.dir, "debian", "osv"))); err != nil {
...
func newCmdFetchRedhatOvalRepositoryToCPE() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			if err := redhatOvalRepositoryToCPE.Fetch(redhatOvalRepositoryToCPE.WithDir(filepath.Join(options.dir, "redhat", "oval", "repository-to-cpe"))); err != nil {
...
func newCmdFetchRedhatOvalV1() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			if err := redhatOvalV1.Fetch(redhatOvalV1.WithDir(filepath.Join(options.dir, "redhat", "oval", "v1"))); err != nil {
				return errors.Wrap(err, "failed to fetch redhat ovalv1")
			}
			return nil
		},
...
func newCmdFetchRedhatOvalV2() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			if err := redhatOvalV2.Fetch(redhatOvalV2.WithDir(filepath.Join(options.dir, "redhat", "oval", "v2"))); err != nil {
...
func newCmdFetchRedhatCVRF() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			// if err := redhatCSAF.Fetch(redhatCSAF.WithDir(filepath.Join(options.dir, "redhat", "csaf"))); err != nil {
...
func newCmdFetchRockyErrata() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			if err := rockyErrata.Fetch(rockyErrata.WithDir(filepath.Join(options.dir, "rocky", "errata"))); err != nil {
...
func newCmdFetchRockyOSV() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			// if err := rockyOSV.Fetch(rockyOSV.WithDir(filepath.Join(options.dir, "rocky", "osv"))); err != nil {
			// 	return errors.Wrap(err, "failed to fetch rocky")
			// }
			return nil
		},
...
func newCmdFetchNVDFeedCVE() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			// 	if err := nvdFeedCVE.Fetch(nvdFeedCVE.WithDir(filepath.Join(options.dir, "nvd", "feed", "cve"))); err != nil {
...
func newCmdFetchNVDFeedCPEDictionary() *cobra.Command {
	options := &options{
		dir: util.SourceDir(),
	}

	cmd := &cobra.Command{
		Use:   "nvd-feed-cpedictionary",
		Short: "Fetch NVD CPE Dictionary Feed data source",
		Example: heredoc.Doc(`
			$ vuls-data-update fetch nvd-feed-cpedictionary
		`),
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			// 	if err := nvdFeedCPEDictionary.Fetch(nvdFeedCPEDictionary.WithDir(filepath.Join(options.dir, "nvd", "feed", "cpedictionary"))); err != nil {
			// 		return errors.Wrap(err, "failed to fetch nvd feed cpedictionary")
			// 	}
			return nil
		},
	}
