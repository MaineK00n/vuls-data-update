...
func newCmdRemote() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: heredoc.Doc(`
			$ vuls-data-update dotgit remote tag ghcr.io/vulsio/vuls-data-db:vuls-data-raw-debian-security-tracker-api:existing-tag new-tag
			$ vuls-data-update dotgit remote untag ghcr.io/vulsio/vuls-data-db:vuls-data-raw-debian-security-tracker-api:existing-tag
		`),
	}
...
func newCmdRemoteTag() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: heredoc.Doc(`
			$ vuls-data-update dotgit remote tag ghcr.io/vulsio/vuls-data-db:vuls-data-raw-debian-security-tracker-api new-tag
			$ vuls-data-update dotgit remote tag ghcr.io/vulsio/vuls-data-db@sha256:5b71484ba9f1565f7ed5cd3aa34b027c44e1773a6e418328ea38a05f9b459f23 new-tag
		`),
...
func newCmdRemoteUntag() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: heredoc.Doc(`
			$ vuls-data-update dotgit remote untag ghcr.io/vulsio/vuls-data-db:existing-tag
		`),
