...
func TestDiff(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "9/rhel-9-including-unpatched/definitions/oval:com.redhat.cve:def:202426815.json, native git",
			args: args{
				...
				opts:       []file.Option{file.WithUseNativeGit(true), file.WithColor(false)},
			},
...
`,
		...
		{
			name: "9/rhel-9-including-unpatched/definitions/oval:com.redhat.cve:def:202426815.json, go-git",
			args: args{
				repository: "testdata/fixtures/vuls-data-raw-redhat-ovalv2.tar.zst",
				minus:      "63a30ff24dea0d2198c1e3160c33b52df66970a4:9/rhel-9-including-unpatched/definitions/oval:com.redhat.cve:def:202426815.json",
				plus:       "main:9/rhel-9-including-unpatched/definitions/oval:com.redhat.cve:def:202426815.json",
				opts:       []file.Option{file.WithUseNativeGit(false), file.WithColor(false)},
			},
			want: `diff --git a/9/rhel-9-including-unpatched/definitions/oval:com.redhat.cve:def:202426815.json b/9/rhel-9-including-unpatched/definitions/oval:com.redhat.cve:def:202426815.json
...
`,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := file.Diff(filepath.Join(dir, strings.TrimSuffix(filepath.Base(tt.args.repository), ".tar.zst")), tt.args.minus, tt.args.plus, tt.args.opts...)
			switch {
