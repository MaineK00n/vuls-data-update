...
import (
	...
	"github.com/MaineK00n/vuls-data-update/pkg/build/library/npm/db"
	"github.com/MaineK00n/vuls-data-update/pkg/build/library/npm/ghsa"
	"github.com/MaineK00n/vuls-data-update/pkg/build/library/npm/glsa"
	"github.com/MaineK00n/vuls-data-update/pkg/build/library/npm/osv"
...
func Build(opts ...Option) error {
	options := &options{
		srcDir:        filepath.Join(util.SourceDir(), "npm"),
		destVulnDir:   filepath.Join(util.DestDir(), "vulnerability"),
		destDetectDir: filepath.Join(util.DestDir(), "library", "npm"),
	}
