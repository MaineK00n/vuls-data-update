...
- Fill default directory in options using the repo’s existing extract path pattern; this usually includes domain/name segments, e.g. `dir: filepath.Join(util.CacheDir(), "extract", "<domain>", "<name>")`
